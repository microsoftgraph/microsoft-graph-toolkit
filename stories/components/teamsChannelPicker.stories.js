  ...
  <script>
    document.querySelector(".button").addEventListener("click", _ => {
      ...
      if (picker.selectedItem) {
        output.innerHTML =
          "<b>channel:</b> " + picker.selectedItem.channel.displayName;
        output.innerHTML +=
          "<br/><b>team:</b> " + picker.selectedItem.team.displayName;
      } else {
...
export const selectChannel = () => html`
  ...
  <script>
    ...
    button.addEventListener("click", async _ => {
      ...
      await picker.selectChannelById(
        "19:d0bba23c2fc8413991125a43a54cc30e@thread.skype"
      );
