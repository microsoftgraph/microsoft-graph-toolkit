  ...
  class U {
    ...
    async cachePut(t, e) {
      ...
      for (const t of this.iterateCallbacks('cacheDidUpdate'))
        await t({ cacheName: c, oldResponse: f, newResponse: a.clone(), request: r, event: this.event });
      return !0;
    }
    async getCacheKey(t, e) {
      ...
      if (!this.u[s]) {
        ...
        for (const t of this.iterateCallbacks('cacheKeyWillBeUsed'))
          n = q(await t({ mode: e, request: n, event: this.event, params: this.params }));
        this.u[s] = n;
      }
      return this.u[s];
    }
    ...
    N() {
      ...
      for (const [s, n] of this.plugins.entries())
        n !== L.copyRedirectedCacheableResponsesPlugin &&
          (n === L.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++);
      0 === e
...
//# sourceMappingURL=workbox-dae083bf.js.map
