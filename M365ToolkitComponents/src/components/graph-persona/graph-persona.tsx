...
export class PersonaComponent {
    ...
    render() {
        ...
        return <div class="persona-container" style={style}>
            {this.renderImage()}
        </div>
    }
    ...
    renderEmptyImage() {
        return <svg width={this.imageSize} height={this.imageSize} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
