...
export class TeamsProvider implements IProvider {
    ...
    static beginAuth(){
        ...
        microsoftTeams.getContext(function (context) {
          ...
          var loginPopupEndUrl = decodeURI(url.searchParams.get("loginPopupEndUrl"));
          var queryParams = {
            client_id: clientId,
            response_type: "id_token token",
            response_mode: "fragment",
            resource: "https://graph.microsoft.com/",
            redirect_uri: loginPopupEndUrl,
            nonce: _guid(),
            state: state,
    ...
    async getAccessToken(): Promise<string> {
        ...
        return new Promise((resolve, reject) => {
            ...
            url.searchParams.append('loginPopupEndUrl', this._loginPopupEndUrl);
