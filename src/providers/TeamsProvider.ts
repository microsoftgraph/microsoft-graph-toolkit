...
export class TeamsProvider implements IProvider {
  ...
  static auth() {
    ...
    if (url.searchParams.get("clientId")) {
      ...
      var hashParams = this.getHashParameters();
  ...
  // (From ADAL.js: https://github.com/AzureAD/azure-activedirectory-library-for-js/blob/dev/lib/adal.js)
  public static _decimalToHex(number) {
  ...
  public static getHashParameters() {
    var hashParams = {};
    location.hash
      .substr(1)
      .split("&")
