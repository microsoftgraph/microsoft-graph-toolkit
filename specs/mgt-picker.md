...
| title-property                  | titleProperty                 | Specify the entity property to use as the title field in the picker. By default, we should use the following : `displayName` / `title` / `name` / `subject` / `id`.                                                                                                                                          | string                     |
