...
import { Providers, ProviderState, MgtTemplatedComponent, customElementHelper, mgtHtml } from '@microsoft/mgt-element';
 ...
 *
 */
@customElement(`${customElementHelper.prefix}-teams-channel-picker`)
