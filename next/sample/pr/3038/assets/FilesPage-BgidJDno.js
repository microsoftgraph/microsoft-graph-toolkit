import{p as fe,b as P,a as Z,r as S,j as d}from"./index-SQF6srv3.js";import{P as me}from"./PageHeader-BqPL8Yoh.js";import{bp as ge,bq as ve,m as b,aE as z,br as H,t as A,bs as j,F as B,_ as a,b as g,o as x,bt as V,bu as be,bv as q,w as I,u as ie,bw as se,k as xe,l as ye,j as we,f as $e,g as Ce,c as ke,d as Se,D as Ie,bx as Fe,x as C,y as N,E as U,G as M,by as y,J as T,bz as _e,bA as Te,bB as L,bC as Le,P as re,Q as h,bD as ae,bE as Ee,z as Ae,C as w,B as Be,bF as le,bG as de,bH as Ve,bI as Ne,bJ as Re,I as De,bK as Pe,bL as Me,bM as ze,bN as He,bO as je,aG as qe,L as Ue,W as We,bP as J,aL as Ge,aM as Q,bQ as Ke,bR as Oe,Z as Ze,a1 as Je,X as Qe,Y as f,a4 as Xe,a6 as Ye,bS as et,bT as X,a2 as Y,a3 as ee,a8 as ce,aC as tt,a9 as W,an as G,aq as ot,ar as nt,as as _}from"./App-CoLF4lmh.js";import{c as te}from"./repeat-Da75-bsA.js";import{r as it}from"./mgt-spinner-BN04ka79.js";import{D as st}from"./index-CxAha1Lg.js";import{f as rt}from"./index-50CfgXI0.js";import{r as at}from"./mgt-file-list-DSKORk7d.js";import{r as lt}from"./mgt-picker-BKfLRxfn.js";import"./graph.files-CUIwBZnv.js";import"./mgt-file-HyPQvsFc.js";import"./mgt-get-FGwr4ofP.js";class dt extends ve{constructor(t,e){super(t,e),this.observer=null,e.childList=!0}observe(){this.observer===null&&(this.observer=new MutationObserver(this.handleEvent.bind(this))),this.observer.observe(this.target,this.options)}disconnect(){this.observer.disconnect()}getNodes(){return"subtree"in this.options?Array.from(this.target.querySelectorAll(this.options.selector)):Array.from(this.target.childNodes)}}function ct(n){return typeof n=="string"&&(n={property:n}),new ge("fast-children",dt,n)}const ht=(n,t)=>b`
    <a
        class="control"
        part="control"
...
`;class v extends B{constructor(){super(...arguments),this.handleUnsupportedDelegatesFocus=()=>{var t;window.ShadowRoot&&!window.ShadowRoot.prototype.hasOwnProperty("delegatesFocus")&&(!((t=this.$fastController.definition.shadowOptions)===null||t===void 0)&&t.delegatesFocus)&&(this.focus=()=>{var e;(e=this.control)===null||e===void 0||e.focus()})}}connectedCallback(){super.connectedCallback(),this.handleUnsupportedDelegatesFocus()}}a([g],v.prototype,"download",void 0);a([g],v.prototype,"href",void 0);a([g],v.prototype,"hreflang",void 0);a([g],v.prototype,"ping",void 0);a([g],v.prototype,"referrerpolicy",void 0);a([g],v.prototype,"rel",void 0);a([g],v.prototype,"target",void 0);a([g],v.prototype,"type",void 0);a([x],v.prototype,"defaultSlottedContent",void 0);class R{}a([g({attribute:"aria-expanded"})],R.prototype,"ariaExpanded",void 0);V(R,be);V(v,q,R);const ut=(n,t)=>b`
...
`;class F extends v{constructor(){super(...arguments),this.separator=!0}}a([x],F.prototype,"separator",void 0);V(F,q,R);const pt=(n,t)=>b`
...
`,vt=he.compose({baseName:"breadcrumb",template:pt,styles:gt}),bt=(n,t)=>C`
    ${N("inline-flex")} :host {
...
`,wt=D.compose({baseName:"tree-view",template:mt,styles:yt}),$t=C`
...
`,oe=Ee`((${Ae} / 2) * ${w}) + ((${w} * ${Be}) / 2)`,kt=le.create("tree-item-expand-collapse-hover").withDefault(n=>{const t=de.getValueFor(n);return t.evaluate(n,t.evaluate(n).hover).hover}),St=le.create("tree-item-expand-collapse-selected-hover").withDefault(n=>{const t=Ve.getValueFor(n);return de.getValueFor(n).evaluate(n,t.evaluate(n).rest).hover}),It=(n,t)=>C`
  ...
  `.withBehaviors(new st($t,Ct),re(C`
        :host {
          color: ${h.ButtonText};
        }
        .positioning-region {
...
`];var K=function(n,t,e,o){function s(i){return i instanceof e?i:new e(function(r){r(i)})}return new(e||(e=Promise))(function(i,r){function l(p){try{m(o.next(p))}catch(k){r(k)}}function u(p){try{m(o.throw(p))}catch(k){r(k)}}function m(p){p.done?i(p.value):s(p.value).then(l,u)}m((o=o.apply(n,t||[])).next())})};const Tt=["Team.ReadBasic.All","TeamSettings.Read.All","TeamSettings.ReadWrite.All","User.Read.All","User.ReadWrite.All"],Lt=["Channel.ReadBasic.All","ChannelSettings.Read.All","ChannelSettings.ReadWrite.All"],Et=["Team.ReadBasic.All","TeamSettings.Read.All","TeamSettings.ReadWrite.All"],At=n=>K(void 0,void 0,void 0,function*(){const t=Tt,e=yield n.api("/me/joinedTeams").select(["displayName","id","isArchived"]).middlewareOptions(fe(t)).get();return e==null?void 0:e.value}),Bt=(n,t)=>K(void 0,void 0,void 0,function*(){let e,o={};if(J()){e=Ge.getCache(Q.photos,Q.photos.stores.teams);for(const s of t)try{const i=yield e.getValue(s);i&&Ke()>Date.now()-i.timeCached&&(o[s]=i)}catch{}if(Object.keys(o).length)return o}o={};for(const s of t)try{const i=yield Oe(n,`/teams/${s}`,Et);J()&&i&&(yield e.putValue(s,i)),o[s]=i}catch{}return o}),Vt=(n,t)=>K(void 0,void 0,void 0,function*(){var e,o;const s=n.createBatch();for(const l of t)s.get(l.id,`teams/${l.id}/channels`,Lt);const i=yield s.executeAll(),r=[];for(const l of t){const u=i.get(l.id);!((o=(e=u==null?void 0:u.content)===null||e===void 0?void 0:e.value)===null||o===void 0)&&o.length&&r.push({item:l,channels:u.content.value.map(m=>({item:m}))})}return r}),Nt={inputPlaceholderText:"Select a channel",noResultsFound:"We didn't find any matches.",loadingMessage:"Loading...",photoFor:"Teams photo for",teamsChannels:"Teams and channels results",closeButtonAriaLabel:"remove the selected channel"};var ue=function(n,t,e,o){var s=arguments.length,i=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,t,e,o);else for(var l=n.length-1;l>=0;l--)(r=n[l])&&(i=(s<3?r(i):s>3?r(t,e,i):r(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i},pe=function(n,t){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(n,t)},ne=function(n,t,e,o){function s(i){return i instanceof e?i:new e(function(r){r(i)})}return new(e||(e=Promise))(function(i,r){function l(p){try{m(o.next(p))}catch(k){r(k)}}function u(p){try{m(o.throw(p))}catch(k){r(k)}}function m(p){p.done?i(p.value):s(p.value).then(l,u)}m((o=o.apply(n,t||[])).next())})};const Rt=()=>{Ze(vt,xt,tt,wt,Ft,rt),it(),Je("teams-channel-picker",O)};class O extends Qe{static get styles(){return _t}get strings(){return Nt}get selectedItem(){return this._selectedItemState?{channel:this._selectedItemState.item,team:this._selectedItemState.parent.item}:null}static get requiredScopes(){return["team.readbasic.all","channel.readbasic.all"]}set items(t){this._items!==t&&(this._items=t,this._treeViewState=t?this.generateTreeViewState(t):[],this.resetFocusState())}get items(){return this._items}get _inputWrapper(){return this.renderRoot.querySelector("fluent-text-field")}get _input(){const t=this._inputWrapper;return t==null?void 0:t.shadowRoot.querySelector("input")}constructor(){super(),this.teamsPhotos={},this._inputValue="",this._treeViewState=[],this._focusList=[],this.renderLoading=()=>this.renderContent(),this.renderContent=()=>{var t;const e={dropdown:!0,visible:this._isDropdownVisible};return this.renderTemplate("default",{teams:(t=this.items)!==null&&t!==void 0?t:[]})||f`
    ...
    `}showCloseIcon(){const t=this.renderRoot.querySelector(".down-chevron"),e=this.renderRoot.querySelector(".up-chevron"),o=this.renderRoot.querySelector(".close-icon");t&&(t.style.display="none"),e&&(e.style.display="none"),o&&(o.style.display=null)}renderDownChevron(){return f`
      ...
      </fluent-button>`}renderChevrons(){return f`${this.renderUpChevron()}${this.renderDownChevron()}`}renderDropdown(){return this._task.status===X.PENDING||!this._treeViewState?this.renderLoadingIndicator():this._treeViewState?this._treeViewState.length===0&&this._inputValue.length>0?this.renderError():this.renderDropdownList(this._treeViewState):f``}renderDropdownList(t){if(t&&t.length>0){let e=null;return f`
        <fluent-tree-view
          class="tree-view"
          dir=${this.direction}
          aria-live="polite"
