...
`,lt={separator:"separator",presentation:"presentation"};class Z extends K{constructor(){super(...arguments),this.role=lt.separator,this.orientation=Ze.horizontal}}l([p],Z.prototype,"role",void 0);l([p],Z.prototype,"orientation",void 0);const ht=(s,e)=>X`
  ...
  `.withBehaviors(Ae(G`
      ...
      `));class pt extends m{connectedCallback(){super.connectedCallback(),Q.setValueFor(this,_e)}}const gt=pt.compose({baseName:"tooltip",baseClass:m,template:ht,styles:ut}),C={modified:"modified on",back:"Back",next:"Next",pages:"pages",page:"Page"},ft=[je`
