...
`,lt={separator:"separator",presentation:"presentation"};class Z extends K{constructor(){super(...arguments),this.role=lt.separator,this.orientation=Ze.horizontal}}l([p],Z.prototype,"role",void 0);l([p],Z.prototype,"orientation",void 0);const ht=(s,e)=>X`
  ...
  `.withBehaviors(Ae(G`
      ...
      `));class pt extends v{connectedCallback(){super.connectedCallback(),J.setValueFor(this,_e)}}const gt=pt.compose({baseName:"tooltip",baseClass:v,template:ht,styles:ut}),C={modified:"modified on",back:"Back",next:"Next",pages:"pages",page:"Page"},ft=[je`
...
`];var x=function(s,e,t,i){var r=arguments.length,o=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,h;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,i);else for(var c=s.length-1;c>=0;c--)(h=s[c])&&(o=(r<3?h(o):r>3?h(e,t,o):h(e,t))||o);return r>3&&o&&Object.defineProperty(e,t,o),o},y=function(s,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(s,e)},mt=function(s,e,t,i){function r(o){return o instanceof t?o:new t(function(h){h(o)})}return new(t||(t=Promise))(function(o,h){function c(m){try{g(i.next(m))}catch(u){h(u)}}function d(m){try{g(i.throw(m))}catch(u){h(u)}}function g(m){m.done?o(m.value):r(m.value).then(c,d)}g((i=i.apply(s,e||[])).next())})};const vt=()=>{Ue(Xe,Ye,gt,dt),ve(),qe(),Ve("search-results",w)};class w extends He{static get styles(){return ft}get strings(){return C}get queryString(){return this._queryString}set queryString(e){this._queryString!==e&&(this._queryString=e,this.currentPage=1)}get from(){return(this.currentPage-1)*this.size}get size(){return this._size}set size(e){e>this.maxPageSize?this._size=this.maxPageSize:this._size=e}get searchEndpoint(){return"/search/query"}get maxPageSize(){return 1e3}constructor(){super(),this._size=10,this.entityTypes=["driveItem","listItem","site"],this.scopes=[],this.contentSources=[],this.version="v1.0",this.pagingMax=7,this.enableTopResults=!1,this.cacheEnabled=!1,this.cacheInvalidationPeriod=3e4,this.isRefreshing=!1,this.defaultFields=["webUrl","lastModifiedBy","lastModifiedDateTime","summary","displayName","name"],this.currentPage=1,this.renderContent=()=>{var e,t,i,r,o,h,c,d;let g=null,m=null,u=null;return this.hasTemplate("header")&&(m=this.renderTemplate("header",this.response)),u=this.renderFooter((t=(e=this.response)===null||e===void 0?void 0:e.value[0])===null||t===void 0?void 0:t.hitsContainers[0]),this.response&&this.hasTemplate("default")?g=this.renderTemplate("default",this.response)||f``:!((r=(i=this.response)===null||i===void 0?void 0:i.value[0])===null||r===void 0)&&r.hitsContainers[0]?g=f`${(d=(c=(h=(o=this.response)===null||o===void 0?void 0:o.value[0])===null||h===void 0?void 0:h.hitsContainers[0])===null||c===void 0?void 0:c.hits)===null||d===void 0?void 0:d.map(b=>this.renderResult(b))}`:this.hasTemplate("no-data")?g=this.renderTemplate("no-data",null):g=f``,f`
      ...
      ${e.some(t=>t===1)?E:f`
              ...
              >
                ...
              </fluent-button>`:E}`}getDotButtonTitle(){return`${C.back} ${Math.ceil(this.pagingMax/2)} ${C.pages}`}renderPreviousPage(){return this.currentPage>1?f`
          <fluent-button
            appearance="stealth"
            class="search-results-page"
            title="${C.back}"
