...
const ChatListWrapper = memo(({ onSelected, selectedItemId }: { onSelected: (e: GraphChat) => void, selectedItemId?: string }) => {
    ...
    <div className="App">
      ...
      <main className="main">
        <div className="chat-selector">
          <ChatListWrapper onSelected={chatSelected} selectedItemId={chatId} />
          <br />
