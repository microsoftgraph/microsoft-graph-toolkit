...
var d = {},
  e = function () {
    var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 'all';
    return ((a = a.toString()), d.hasOwnProperty(a))
      ? d[a]
      : ('11' === a
          ? (d[a] = -1 !== navigator.userAgent.indexOf('Trident'))
          : '10' === a
          ? (d[a] = -1 !== navigator.appVersion.indexOf('MSIE 10'))
          : 'all' === a
          ? (d[a] = -1 !== navigator.userAgent.indexOf('Trident') || -1 !== navigator.userAgent.indexOf('MSIE'))
          : void 0,
        (d.all =
          d.all ||
...
function f(b) {
  ...
  for (var c = e(10) ? document.body : null, d = b.offsetParent; d === c && b.nextElementSibling; )
...
function r(b) {
  ...
  if (l || n) {
    var p = a(b);
    (l -= m(p, 'x')), (n -= m(p, 'y')), (g.width -= l), (g.height -= n);
  }
  return q(g);
}
function s(b, d) {
  ...
  g && 'HTML' === d.nodeName && ((k.top = f(k.top, 0)), (k.left = f(k.left, 0)));
  var s = q({ top: j.top - k.top - o, left: j.left - k.left - p, width: j.width, height: j.height });
  if (((s.marginTop = 0), (s.marginLeft = 0), !h && i)) {
    var t = parseFloat(n.marginTop, 10),
      u = parseFloat(n.marginLeft, 10);
    (s.top -= o - t), (s.bottom -= o - t), (s.left -= p - u), (s.right -= p - u), (s.marginTop = t), (s.marginLeft = u);
  }
...
function u(c) {
  var d = c.nodeName;
  return 'BODY' === d || 'HTML' === d ? !1 : !('fixed' !== a(c, 'position')) || u(b(c));
}
function v(b) {
  if (!b || !b.parentElement || e()) return document.documentElement;
...
function w(a, d, e, f) {
  var g = 4 < arguments.length && void 0 !== arguments[4] && arguments[4],
    h = { top: 0, left: 0 },
    i = g ? v(a) : j(a, d);
  if ('viewport' === f) h = t(i, g);
  else {
    var k;
    'scrollParent' === f
      ? ((k = c(b(d))), 'BODY' === k.nodeName && (k = a.ownerDocument.documentElement))
      : 'window' === f
      ? (k = a.ownerDocument.documentElement)
      : (k = f);
    var l = s(k, i, g);
    if ('HTML' === k.nodeName && !u(i)) {
      var m = o(),
        n = m.height,
        p = m.width;
...
function U(a, b, c) {
  ...
  return (
    d.forEach(function (a) {
      ...
      a.enabled &&
        O(c) &&
        ((b.offsets.popper = q(b.offsets.popper)), (b.offsets.reference = q(b.offsets.reference)), (b = c(b, a)));
    }),
    b
  );
}
...
var Z = {
  ...
  getOffsetParent: f,
  getOffsetRect: I,
  getOffsetRectRelativeToArbitraryNode: s,
  getOuterSizes: J,
  getParentNode: b,
  getPopperOffsets: L,
...
export {
  y as computeAutoPlacement,
  F as debounce,
  H as findIndex,
  m as getBordersSize,
  w as getBoundaries,
  r as getBoundingClientRect,
  q as getClientRect,
  f as getOffsetParent,
  I as getOffsetRect,
  s as getOffsetRectRelativeToArbitraryNode,
  J as getOuterSizes,
  b as getParentNode,
