...
var m = {},
  h = function () {
    ...
    return ((e = e.toString()), m.hasOwnProperty(e))
      ? m[e]
      : ('11' === e
          ? (m[e] = -1 !== navigator.userAgent.indexOf('Trident'))
          : '10' === e
          ? (m[e] = -1 !== navigator.appVersion.indexOf('MSIE 10'))
          : 'all' === e
          ? (m[e] = -1 !== navigator.userAgent.indexOf('Trident') || -1 !== navigator.userAgent.indexOf('MSIE'))
          : void 0,
        (m.all =
          m.all ||
...
function c(e) {
  ...
  for (var t = h(10) ? document.body : null, o = e.offsetParent; o === t && e.nextElementSibling; )
...
function C(e) {
  ...
  if (d || l) {
    var f = a(e);
    (d -= E(f, 'x')), (l -= E(f, 'y')), (i.width -= d), (i.height -= l);
  }
  return D(i);
}
function N(e, t) {
  ...
  var g = D({ top: p.top - s.top - m, left: p.left - s.left - c, width: p.width, height: p.height });
...
function P(e) {
  var t = e.nodeName;
  return 'BODY' === t || 'HTML' === t ? !1 : !('fixed' !== a(e, 'position')) || P(l(e));
}
function W(e) {
...
function R(e, t, o) {
  ...
  var n = M(e),
    ...
    d = r ? 'height' : 'width',
    a = r ? 'width' : 'height';
  return (i[p] = t[p] + t[d] / 2 - n[d] / 2), (i[s] = o === s ? t[s] - n[a] : t[F(s)]), i;
}
function U(e, t) {
...
function _(e, t, o, n) {
  ...
  r.addEventListener(t, o, { passive: !0 }), i || _(f(r.parentNode), t, o, n), n.push(r);
}
function X(e, t, o, n) {
...
function ee(e, t) {
  Object.keys(t).forEach(function (o) {
    var n = '';
    -1 !== ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(o) && $(t[o]) && (n = 'px'),
      (e.style[o] = t[o] + n);
  });
}
function te(e, t) {
...
function ie(e, t) {
  ...
  var s,
    ...
    b = V('transform');
  if (((d = 'bottom' == g ? -f.height + h.bottom : h.top), (s = 'right' == u ? -f.width + h.right : h.left), a && b))
    (m[b] = 'translate3d(' + s + 'px, ' + d + 'px, 0)'), (m[g] = 0), (m[u] = 0), (m.willChange = 'transform');
  else {
    var y = 'bottom' == g ? -1 : 1,
      w = 'right' == u ? -1 : 1;
    (m[g] = d * y), (m[u] = s * w), (m.willChange = g + ', ' + u);
  }
  var E = { 'x-placement': e.placement };
  return (
    (e.attributes = T({}, E, e.attributes)),
    (e.styles = T({}, m, e.styles)),
...
function le(e) {
  var t = 1 < arguments.length && arguments[1] !== void 0 && arguments[1],
    o = ae.indexOf(e),
    n = ae.slice(o + 1).concat(ae.slice(0, o));
  return t ? n.reverse() : n;
}
var fe = { FLIP: 'flip', CLOCKWISE: 'clockwise', COUNTERCLOCKWISE: 'counterclockwise' };
function me(e, t) {
...
function be(e, t) {
  ...
  var n = B(e.instance.popper, e.instance.reference, t.padding, o, e.positionFixed);
  t.boundaries = n;
  var i = t.priority,
    r = e.offsets.popper,
    p = {
      primary: function (e) {
        var o = r[e];
        return r[e] < n[e] && !t.escapeWithReference && (o = Math.max(r[e], n[e])), S({}, e, o);
      },
      secondary: function (e) {
        var o = 'right' === e ? 'left' : 'top',
          i = r[o];
        return (
          r[e] > n[e] && !t.escapeWithReference && (i = Math.min(r[o], n[e] - ('right' === e ? r.width : r.height))),
          S({}, o, i)
        );
      }
    };
...
var ve = {
    ...
    flip: { order: 600, enabled: !0, fn: me, behavior: 'flip', padding: 5, boundariesElement: 'viewport' },
    inner: { order: 700, enabled: !1, fn: Ee },
    hide: { order: 800, enabled: !0, fn: we },
    computeStyle: { order: 850, enabled: !0, fn: ie, gpuAcceleration: !0, x: 'bottom', y: 'right' },
...
(Oe.Utils = ('undefined' == typeof window ? global : window).PopperUtils), (Oe.placements = de), (Oe.Defaults = xe);
export default Oe;
